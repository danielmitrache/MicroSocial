...
namespace MicroSocial.Data.Migrations
{
    ...
    [Migration("20251215222352_FixedPK2")]
    partial class FixedPK2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Follow", b =>
                {
                    b.HasOne("ApplicationUser", "FollowedUser")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ApplicationUser", "FollowingUser")
                        .WithMany("Following")
            ...
            modelBuilder.Entity("Group", b =>
                {
                    b.HasOne("ApplicationUser", "Moderator")
